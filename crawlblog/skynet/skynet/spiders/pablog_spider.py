...
from skynet.skynet.interactors import BaseSpider
...
class CblogsSpider(BaseSpider):
    ...
    def parse(self,response):
        ...
        # item["title"]=res.xpath("//*[@id='post_list']/div[1]/div[2]/h3/a").extract()
        # item["content"] = res.xpath("//*[@id='post_list']/div[1]/div[2]/p/text()").extract()
        # logger.info(item["title"],item["content"])
        # print("3333333333333333333",item["title"], item["content"])
        for i in range(1,4):
